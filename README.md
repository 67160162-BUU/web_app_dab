# DAB DETECTOR — The Dab Challenge

เว็บเกมตรวจจับท่า **Dab** ด้วยกล้อง ใช้ **Google MediaPipe Pose Landmarker** อ่านโครงร่างร่างกาย 33 จุดแบบเรียลไทม์ แล้วให้คะแนนว่าทำท่าได้เป๊ะแค่ไหน
